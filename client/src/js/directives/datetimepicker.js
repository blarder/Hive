 ...
 */
    ...
    angular.module('ui.bootstrap.datetimepicker', ['moment'])
        ...
        .directive('datetimepicker', ['$log', 'dateTimePickerConfig', 'moment', function datetimepickerDirective($log, defaultConfig, moment) {
            ...
            return {
                ...
                template: '<div class="datetimepicker table-responsive">' +
                    ...
                    '   <thead>' +
                    '       <tr>' +
                    '           <th class="left" data-ng-click="changeView(data.currentView, data.leftDate, $event)" data-ng-show="data.leftDate.selectable"><i class="fa fa-caret-square-o-left"/></th>' +
                    '           <th colspan="5" data-ng-show="data.previousViewDate.selectable" data-ng-click="changeView(data.previousView, data.previousViewDate, $event)">{{ data.previousViewDate.display }}</th>' +
                    '           <th class="right" data-ng-click="changeView(data.currentView, data.rightDate, $event)" data-ng-show="data.rightDate.selectable"><i class="fa fa-caret-square-o-right"/></th>' +
                    '       </tr>' +
                    '       <tr>' +
